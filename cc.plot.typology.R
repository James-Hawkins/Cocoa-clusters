...
# assign string names to clusters  
  ...
  for (T in typologies){
    ...
    comp[comp$hhID %in% data[data$typ == i,    'hhID']  ,'facet.lab']  <-  'System aggregates'
